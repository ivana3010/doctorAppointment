...
const TopDoctors = () => {
    ...
    return (
        <div className='flex flex-col items-center gap-4 my-8 text-gray-900 md:mx-10'>
            ...
            <div className='w-[300px] md:w-full grid grid-cols-auto gap-10 pt-5 gap-y-6 px-3 sm:px-0'>
                {doctors.slice(0, screen).map((item, index) => (
            ...
            <button oClick={() => { navigate('/doctors'); scrollTo(0, 0) }} className='bg-blue-100 text-gray-800 px-20 py-3 rounded-full my-3'>more</button>
        </div>
    )
}
