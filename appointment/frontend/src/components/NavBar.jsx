...
const NavBar = () => {
  ...
  return (
    <div className='flex items-center justify-between text-md pt-3 pb-2 mb-5 border-b border-b-gray-400'>
        <img onClick={()=>navigate('/')} className='w-32 cursor-pointer' src={assets.logo1} alt="" />
        ...
        <div className='gap-4 flex items-center'> 
            ...
            <div className={`${showMenu ? 'fixed w-full' :'h-0 w-0'} md:hidden right-0 top-0 bottom-0 z-20 overflow-hidden bg-white transition-all`}>
                ...
                <ul className='flex flex-col items-center gap-10 mt-5 text-lg font-medium '>
                    ...
                    <NavLink to='/doctors' onClick={()=>setShowMenu(false)}><p>DOCTORS</p></NavLink>
